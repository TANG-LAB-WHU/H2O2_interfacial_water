...
if exist "%DEFAULT_MODEL%" (
    ...
    %DOCKER_COMPOSE_CMD% run --rm mace_model_conversion "cd /workspace && pip uninstall -y cuequivariance cuequivariance-torch cuequivariance-ops-torch-cu12 cuequivariance-ops 2>/dev/null; python3 convert_mace_to_mliap.py" >> "!LOG_FILE!" 2>&1
    if errorlevel 1 (
